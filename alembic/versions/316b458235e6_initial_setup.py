...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role", sa.String(length=20), server_default="employee", nullable=False
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_persons_employee_id"), "persons", ["employee_id"], unique=True
    )
    ...
    op.create_index(
        op.f("ix_attendance_person_id"), "attendance", ["person_id"], unique=False
    )
